...
export default function EnhancedAdminDashboard() {
  ...
  const tabs = [
    ...
    { id: 'courses', label: 'Courses', icon: Library, color: 'from-yellow-500 to-orange-600' },
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-slate-400">
                        {quiz.course?.code || 'General'} • {quiz.questionPool?.length || 0} questions • {quiz.durationMinutes} minutes
                      </p>
                    </div>
                    <motion.span
